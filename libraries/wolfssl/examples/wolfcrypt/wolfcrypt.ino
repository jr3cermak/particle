...
//    particle compile photon examples/wolfcrypt/usage.ino
// 
// Memory use: 
//   text	   data	    bss	    dec	    hex	filename
//  28252	      8	   1496	  29756	   743c	/workspace/target/workspace.elf
...
void setup() {
  ...
  Serial.begin(9600);
    ...
    byte salt_3072[] = {
        0xBE, 0xB2, 0x53, 0x79, 0xD1, 0xA8, 0x58, 0x1E, 0xB5, 0xA7, 
        0x27, 0x67, 0x3A, 0x24, 0x41, 0xEE
    };
