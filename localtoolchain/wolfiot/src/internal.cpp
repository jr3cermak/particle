...
/* local.h */
//REF:https://sourceware.org/git/gitweb.cgi?p=newlib-cygwin.git;a=blob_plain;f=newlib/libc/time/local.h;hb=HEAD
...
struct tm* XGMTIME(const time_t* tim_p, struct tm* res) {
  long days, rem;
